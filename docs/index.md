...
heroText: 涛涛之海
tagline: 清醒时做事，糊涂时读书，大怒时睡觉，独处时思考。
# actionText: 立刻进入 →
# actionLink: /web/
...
features: # 可选的
  ...
  - title: Java后端
    details: Java源码，框架，JVM，数据结构等
    link: /ui/
    imgUrl: /img/other.png
  - title: 反洗钱
    details: 反洗钱相关的法律法规以及相关的功能介绍等文章
    link: /technology/
...
<!-- 小熊猫 -->
<img src="/vuepress-theme-vdoing/img/panda-waving.png" class="panda no-zoom" style="width: 130px;height: 115px;opacity: 0.8;margin-bottom: -4px;padding-bottom:0;position: fixed;bottom: 0;left: 0.5rem;z-index: 1;"> 
...
- **WeChat or QQ**: <a href="tencent://message/?uin=894072666&Site=&Menu=yesUrl" class='qq'>736238785</a>
